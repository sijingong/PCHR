...
public class RSAUtils {
    ...
    public static String encryptByPublicKey(String data) throws Exception {
        ...
        byte[] keyBytes = Base64Utils.decode(PUBLIC_KEY).getBytes("utf-8");
    ...
    public static String decryptByPrivateKey(String data) throws Exception {
        byte[] encryptedData = Base64Utils.decode(data).getBytes("utf-8");
        byte[] keyBytes = Base64Utils.decode(PRIVATE_KEY).getBytes("utf-8");
    ...
    public static PublicKey loadPublicKey(String publicKeyStr) throws Exception {
        try {
            byte[] buffer = Base64Utils.decode(publicKeyStr).getBytes("utf-8");
            KeyFactory keyFactory = KeyFactory.getInstance("RSA");
    ...
    public static PrivateKey loadPrivateKey(String privateKeyStr)
            throws Exception {
        try {
            byte[] buffer = Base64Utils.decode(privateKeyStr).getBytes("utf-8");
            // X509EncodedKeySpec keySpec = new X509EncodedKeySpec(buffer);
